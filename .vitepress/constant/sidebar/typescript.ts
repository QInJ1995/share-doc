        ...
        items: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { text: '类与对象', link: 'docs/typescript/basic/04-classes-objects' },
                    { text: '函数', link: 'docs/typescript/basic/05-functions' },
                    { text: '泛型', link: 'docs/typescript/basic/06-generics' },
                    { text: '高级类型', link: 'docs/typescript/basic/07-advanced-types' },
                    { text: '模块与命名空间', link: 'docs/typescript/basic/08-modules-namespaces' },
                    { text: '装饰器', link: 'docs/typescript/basic/09-decorators' },
                    { text: '项目配置', link: 'docs/typescript/basic/10-project-configuration' },
                    { text: '最佳实践', link: 'docs/typescript/basic/11-best-practices' },
                    { text: '常见问题', link: 'docs/typescript/basic/12-faq' }
                ]
            },
            {
                text: '进阶篇',
