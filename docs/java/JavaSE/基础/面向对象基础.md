...
![1662209848898](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662209848898.png)

遇到这样的需求， 以前都会定义方法来做，如下图所示

注意：这里每一个方法有**三个参数**

![1662209886046](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662209886046.png)

![1662209899008](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662209899008.png)

定义好方法之后， 调用方法的时候，需要给每一个方法**传递三个实际参数**

![1662210110729](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662210110729.png)
...
![1662210587156](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662210587156.png)
...
![1662211382446](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662211382446.png)
...
![1662211620054](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662211620054.png)

所以面向对象编程的好处，用一句话总结就是：面向对象的开发更符合人类的思维习惯，让编程变得更加简单、更加直观。

### 2.2 程序中对象到底是个啥？

说完面向对象编程有什么好处之后，这里有人可能会有问题了，你刚才举的例子中，“汽车”、“手机”、“蔡徐坤”是一个实实在在的东西，你说是一个对象好理解。那 程序中的对象到底是个啥呢？

**对象实质上是一种特殊的数据结构**。这种结构怎么理解呢？

你可以把对象理解成一张表格，表当中记录的数据，就是对象拥有的数据。

![1662212402342](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662212402342.png)
...
![1662213156309](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662213156309.png)

需要按照对象的设计图创造一个对象。**设计图中规定有哪些数据，对象中就只能有哪些数据。**

![1662213268590](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662213268590.png)
...
![1662213744520](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662213744520.png)
...
![1662213891968](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662213891968.png)
...
![1662214650611](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662214650611.png)

如下图所示，s1和s2两个变量记录的是同一个对象的地址值，s1修改对象的属性值，再用s2访问这个属性，会发现已经被修改了。

![1662215061486](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662215061486.png)
...
![1662301823320](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662301823320.png)

上面代码运行结果如下

![1662302089326](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662302089326.png)

**this有什么用呢？**

通过this在方法中可以访问本类对象的成员变量。 看下图代码，分析打印结果是多少

![1662303254161](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662303254161.png)

分析上面的代码`s3.score=325`，调用方法printPass方法时，方法中的`this.score`也是325； 而方法中的参数score接收的是250。执行结果是

![1662303676092](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662303676092.png)
...
![1662304435504](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662304435504.png)
...
- **构造器的特点？**
  ...
  ![1662304779863](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662304779863.png)

  当执行`new Student("播仔",99)`创建对象时，就是在执行有参数构造器，当有参数构造器执行完，就意味着对象创建完毕了。

  ![1662304859276](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662304859276.png)
...
![1662305406056](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662305406056.png)
...
![1662305928023](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662305928023.png)
...
![1662306602412](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662306602412.png)

在设计汽车时，除了隐藏部分零件，但是还是得合理的暴露一些东西出来，让司机能够操纵汽车，让汽车跑起来。比如：点火按钮啊、方向盘啊、刹车啊、油门啊、档把啊... 这些就是故意暴露出来让司机操纵汽车的。

![1662306879230](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662306879230.png)
...
![1662307191295](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662307191295.png)
...
![1662335204398](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662335204398.png)

接下来 按照要求，写一个Student实体类；

![1662335451401](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662335451401.png)
...
![1662336287570](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662336287570.png)
...
![1662337507608](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662337507608.png)
...
![1662351774659](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662351774659.png)

运行程序时，能够根据用户的选择，执行不同的功能，如下图所示

![1662351990387](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662351990387.png)
...
![1662371089114](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662371089114.png)

如下图所示，成员变量在类中方法外，而局部变量在方法中。

![1662353340190](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1662353340190.png)
