...
![1668051403591](/image/java/JavaSE/进阶/多线程/1668051403591.png)
...
![1668052028054](/image/java/JavaSE/进阶/多线程/1668052028054.png)
...
![1668052307537](/image/java/JavaSE/进阶/多线程/1668052307537.png)

我们再尝试，把join()方法去掉，再看执行效果。此时你会发现2号线程没有执行完1号线程就执行了**（效果是多次运行才出现的，根据个人电脑而异，可能半天也出现不了也是正常的）**

![1668052414444](/image/java/JavaSE/进阶/多线程/1668052414444.png)
...
![1668059112092](/image/java/JavaSE/进阶/多线程/1668059112092.png)
...
![1668059997020](/image/java/JavaSE/进阶/多线程/1668059997020.png)
...
![1668060312733](/image/java/JavaSE/进阶/多线程/1668060312733.png)

等小红线程执行完了，把余额改为0，出去了就会释放锁。这时小明线程就可以加锁进来执行，如下图所示。

![1668060382390](/image/java/JavaSE/进阶/多线程/1668060382390.png)
...
![1668064583299](/image/java/JavaSE/进阶/多线程/1668064583299.png)
...
要理解什么是线程复用技术，我们先得看一下不使用线程池会有什么问题，理解了这些问题之后，我们在解释线程复用就好理解了。
...
![1668065892511](/image/java/JavaSE/进阶/多线程/1668065892511.png)



但是任务总有被执行完的时候，假设第1个线程的任务执行完了，那么第1个线程就空闲下来了，有新的任务时，空闲下来的第1个线程可以去执行其他任务。依此内推，这3个线程可以不断的复用，也可以执行很多个任务。

![1668066073126](/image/java/JavaSE/进阶/多线程/1668066073126.png)
...
![1668066279649](/image/java/JavaSE/进阶/多线程/1668066279649.png)
...
![1668066844202](/image/java/JavaSE/进阶/多线程/1668066844202.png)
...
![1668067745116](/image/java/JavaSE/进阶/多线程/1668067745116.png)
...
![1668067798673](/image/java/JavaSE/进阶/多线程/1668067798673.png)
...
![1668067964048](/image/java/JavaSE/进阶/多线程/1668067964048.png)
...
![1668068110593](/image/java/JavaSE/进阶/多线程/1668068110593.png)

接下来，我们演示一下创建固定线程数量的线程池。这几个方法用得不多，所以这里不做过多演示，了解一下就行了。
...
![1668068399363](/image/java/JavaSE/进阶/多线程/1668068399363.png)

## 五、补充知识

最后，我们再补充几个概念性的知识点，知道这些概念什么意思就可以了。
...
![1668069176927](/image/java/JavaSE/进阶/多线程/1668069176927.png)
...
![1668069524799](/image/java/JavaSE/进阶/多线程/1668069524799.png)
...
![1668069740969](/image/java/JavaSE/进阶/多线程/1668069740969.png)

接下来就来学习线程的生命周期。在Thread类中有一个嵌套的枚举类叫Thread.Status，这里面定义了线程的6中状态。如下图所示

![1668069923403](/image/java/JavaSE/进阶/多线程/1668069923403.png)
...
![1668070204768](/image/java/JavaSE/进阶/多线程/1668070204768.png)
