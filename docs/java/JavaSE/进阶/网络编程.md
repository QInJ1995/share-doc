...
![1668262460269](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668262460269.png)

- **BS架构的特点：**BS架构不需要开发客户端软件，用户只需要通过浏览器输入网址就可以直接从服务器获取数据，并由服务器将数据返回给浏览器，用户在页面上就可以看到各种数据了。

  ![1668262589242](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668262589242.png)

这两种结构不管是CS、还是BS都是需要用到网络编程的相关技术。 学习Java的程序员，以后从事的工作方向主要还是BS架构的。
...
![1668262831222](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668262831222.png)
...
![1668263019076](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668263019076.png)
...
![1668263179793](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668263179793.png)

如果想查看本机的IP地址，可以在命令行窗口，输入`ipconfig`命令查看，如下图所示

![1668263481919](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668263481919.png)
...
![1668263759999](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668263759999.png)

在命令行窗口输入`ipconfig`命令，同样可以看到ipv6地址，如下图所示

![1668263881709](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668263881709.png)
...
域名和IP其实是一一对应的，由运营商来管理域名和IP的对应关系。 在浏览器上敲一个域名时，首先由运营商的域名解析服务，把域名转换为ip地址，再通过IP地址去访问对应的服务器设备。

![1668264280209](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668264280209.png)
...
![1668264499362](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668264499362.png)
...
![1668265337659](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668265337659.png)
...
![1668267533206](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668267533206.png)
...
![1668267760295](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668267760295.png)

为了让世界上各种上网设备能够互联互通，肯定需要有一个组织出来，指定一个规则，大家都遵守这个规则，才能进行数据通信。

![1668267891624](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668267891624.png)

只要按照OSI网络参考模型制造的设备，就可以在国际互联网上互联互通。其中传输层有两个协议，是 今天会接触到的（UDP协议、TCP协议）

- **UDP协议特点**

![1668268046104](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668268046104.png)

- **TPC协议特点**

![1668268144938](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668268144938.png)

三次握手如下图所示**：目的是确认通信双方，手法消息都是正常没问题的**

![1668268174867](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668268174867.png)

四次挥手如下图所示：**目的是确保双方数据的收发已经完成，没有数据丢失**

![1668268230804](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668268230804.png)
...
![1668268587965](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668268587965.png)
...
![1668270124031](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668270124031.png)
...
![1668315156739](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668315156739.png)
...
![1668315820569](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668315820569.png)
...
![1668316417640](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668316417640.png)
...
![1668316630797](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1668316630797.png)
