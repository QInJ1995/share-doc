...
![image-20210716092839618](/image/java/Maven/image-20210716092839618.png)

- 将原始模块按照功能拆分成若干个子模块，方便模块间的相互调用，接口共享

![image-20210805122133568](/image/java/Maven/image-20210805122133568.png)
...
![image-20210805122213607](/image/java/Maven/image-20210805122213607.png)
...
![image-20210805122632136](/image/java/Maven/image-20210805122632136.png)
...
![image-20210513163239710](/image/java/Maven/image-20210513163239710.png)
...
![image-20210805154428870](/image/java/Maven/image-20210805154428870.png)
...
![image-20210805123427449](/image/java/Maven/image-20210805123427449.png)
...
![image-20210805124018028](/image/java/Maven/image-20210805124018028.png)
...
![image-20210805124411768](/image/java/Maven/image-20210805124411768.png)
...
![image-20210805124506165](/image/java/Maven/image-20210805124506165.png)
...
![image-20210805124805979](/image/java/Maven/image-20210805124805979.png)
...
![image-20210805125240781](/image/java/Maven/image-20210805125240781.png)
...
![image-20210805125509894](/image/java/Maven/image-20210805125509894.png)
...
![image-20210805125522304](/image/java/Maven/image-20210805125522304.png)
...
![image-20210805125541963](/image/java/Maven/image-20210805125541963.png)
...
![image-20201119201910078](/image/java/Maven/image-20201119201910078.png)

如果私服中没有对应的jar，会去中央仓库下载，速度很慢。可以配置让私服去阿里云中下载依赖。

![image-20210817102823906](/image/java/Maven/image-20210817102823906.png)
