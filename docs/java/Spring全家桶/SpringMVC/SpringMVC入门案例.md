...
![1651596381129](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1651596381129.png)
...
![1651596361174](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1651596361174.png)
...
![1630428920116](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1630428920116.png)

因为使用骨架创建的项目结构不完整，需要手动补全

![1630429288339](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1630429288339.png)
...
![1630430302683](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1630430302683.png)

### 步骤6:启动运行项目

![1630430345246](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1630430345246.png)

### 步骤7:浏览器访问

浏览器输入`http://localhost/save`进行访问，可以看得如下内容

![1651602301329](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1651602301329.png)
...
- 多次工作
  ...
  - 多次工作我们可以通过实现一个用户的删除功能来体验一把
    ...
    ![1651602676209](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1651602676209.png)
...
![1630432494752](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1630432494752.png)
...
3. 加载SpringMvcConfig配置类
   ...
   ![1630433335744](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1630433335744.png)
...
5. 加载UserController，每个@RequestMapping的名称对应一个具体的方法
   ...
   ![1630433398932](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1630433398932.png)
   - 此时就建立了 `/save` 和 save方法的对应关系

6. 执行getServletMappings方法，定义所有的请求都通过SpringMVC

   ![1630433510528](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1630433510528.png)
...
![1630459727575](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1630459727575.png)
...
![1630460319004](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1630460319004.png)

在Spring的配置类`SpringConfig`中使用注解`@ComponentScan`,当时扫描的范围中其实是已经包含了controller,如:

![1630460408159](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1630460408159.png)
...
![1630461261820](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1630461261820.png)
...
![1630462200947](https://lsky-pro.qinlaoshi.dpdns.org:2083/qls/1630462200947.png)
